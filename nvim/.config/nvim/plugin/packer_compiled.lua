...
_G.packer_plugins = {
  ...
  ["cmusp.nvim"] = {
    loaded = true,
    path = "/home/mat/.local/share/nvim/site/pack/packer/start/cmusp.nvim",
    url = "https://github.com//home/mat/misc/neovim-plugins/cmusp.nvim/"
  },
  ["colorbuddy.vim"] = {
    loaded = true,
  ...
  dock = {
    ...
    loaded = true,
    path = "/home/mat/.local/share/nvim/site/pack/packer/start/dock",
    url = "https://github.com//home/mat/misc/neovim-plugins/dock/"
  },
  ["emmet-vim"] = {
    loaded = false,
    needs_bufread = false,
...
-- Config for: dock
time([[Config for dock]], true)
try_loadstring("\27LJ\2\n\v\0\0\1\0\0\0\1K\0\1\0\0", "config", "dock")
time([[Config for dock]], false)
-- Config for: LuaSnip
